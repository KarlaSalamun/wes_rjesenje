...
/* USER CODE BEGIN 0 */
static uint8_t I2S_DMA_tx_complete = 1;
/* USER CODE END 0 */
...
uint8_t HAL_I2S_Transmit_eig(I2S_HandleTypeDef *hi2s, uint16_t *pData, uint16_t Size){
	if ( I2S_DMA_tx_complete== 0 ) return 0;

	HAL_NVIC_DisableIRQ(DMA1_Stream7_IRQn);
	I2S_DMA_tx_complete = 0;
